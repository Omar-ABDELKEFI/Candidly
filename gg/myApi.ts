...
export interface ModelsNotifyEmails {
  createdAt?: string;
  deletedAt?: GormDeletedAt;
  email: string;
  id?: number;
...
export interface ModelsTest {
  ...
  id?: number;
  name: string;
  notifyEmails?: ModelsNotifyEmails[];
  passingScore: number;
  showScore: boolean;
  test_questions?: ModelsTestQuestion[];
  testCondidat?: ModelsTestCondidat[];
  timingPolicy: string;
  updatedAt?: string;
}

export interface ModelsTestCondidat {
  createdAt?: string;
  deletedAt?: GormDeletedAt;
  id?: number;
  question_id: number;
 ...
 * @contact
 *
 * is an application web of interview assessment tests for interviewing out of the box .
 */
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  questions = {
     ...
     */
    editCreate: (question: ModelsQuestion, params: RequestParams = {}) =>
      this.request<ModelsQuestion, any>({
        path: `/questions/edit`,
        method: "POST",
        body: question,
